...
public class FrmPrincipal extends JFrame {
    ...
    private void agregarComponentes() {
        ...
        // BOTONES
        JButton btnEstudiante =
                crearBoton("Estudiantes", 180);

        panel.add(btnEstudiante);

        JButton btnCursos =
                crearBoton("Cursos", 260);

        panel.add(btnCursos);

        JButton btnEvaluacion =
                crearBoton("Evaluaciones", 340);

        panel.add(btnEvaluacion);

        JButton btnInscripcion =
                crearBoton("Inscripciones", 420);

        panel.add(btnInscripcion);

        JButton btnReportes =
                crearBoton("Reportes", 500);

        panel.add(btnReportes);

        JButton btnSalir =
                crearBotonSalir("Salir", 580);
